...
import { CreditCard, ShoppingCart, Wrench, Calendar, Smartphone } from "lucide-react";
...
const projects = [
  {
    ...
    highlights: [
      ...
      "Transaction PIN setup and management for secure operations",
      "QR payment and phone-number-based money transfer features",
      "Collaborated with backend teams to integrate APIs and ensure secure data handling",
    ],
    tech: ["React Native", "REST APIs", "Redux Toolkit"],
  },
  {
    icon: CreditCard,
    title: "ARES Frontend",
    role: "Frontend Developer",
    description: "Developed Profile section, Inter-Transfer and Transaction History modules.",
    highlights: [
      "Gestopago Payment Services with token validation and receipt download",
      "Dynamic KYC forms with document upload based on persona types",
      "Month-wise bank statement download functionality",
      "Managed secure transaction workflows and global state using Redux Toolkit",
    ],
    tech: ["React", "Redux Toolkit", "REST APIs"],
  },
  {
    icon: ShoppingCart,
    title: "OCC Clients (Oracle E-commerce)",
    role: "Frontend Developer",
    ...
    highlights: [
      ...
      "Built and integrated APIs for e-commerce workflows",
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      "Enhanced UI/UX with Slick-carousel and React-icons",
      "Maintained documentation and conducted code reviews",
    ],
    tech: ["React", "Redux", "Formik", "Axios", "Lodash"],
  },
  {
    icon: Calendar,
    ...
    highlights: [
      "Microsoft Login using Azure Authentication",
      "Admin dashboards to manage employees, candidates, and interviewers",
      "Candidate interview score display and modification",
      "Secure frontend-backend API integration",
    ],
